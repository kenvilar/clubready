        ...
        <div class="row">
            ...
            <div class="col-5">
                <div class="form-group required">
                    ...
                    <input type="text" class="form-control" name="first_name" id="first_name" v-model="item.first_name"
                ...
                <div class="form-group required">
                    ...
                    <input type="text" class="form-control" name="last_name" id="last_name" v-model="item.last_name"
                ...
                <div class="form-group required" v-if="!isEditView(item.id)">
                    <label for="password">Password</label>
                    <input type="password" class="form-control" name="password" id="password" v-model="item.password"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="phone_home" id="phone_home" v-model="item.phone_home"
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="alternative_email" id="alternative_email"
                ...
                <div class="form-group">
                    <label for="club_racenumber">Club Racenumber</label>
                    <input type="number" class="form-control" name="club_racenumber" id="club_racenumber"
