...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('web.vehicle.index')}}">Show List</a></li>
        @if (isset($vehicle->id))
            <li><a href="{{route('web.vehicle.show', $vehicle->id)}}">Show Item</a></li>
        @endif
        <li class="active">@if (isset($vehicle->id)) Edit @else Create @endif Item</li>
    </ol>
@endsection
