...
class ClubMemberMembershipController extends Controller
{
    ...
    {
        return view('members.club-members.memberships.show', ['clubMember' => $clubMember, 'membership' => $membership]);
    }
    ...
    {
        return view('members.club-members.memberships.createAndEditForm', ['clubMember' => $clubMember, 'membership' => $membership]);
    }
}
